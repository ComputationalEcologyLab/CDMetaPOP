...
class PreProcessData:
	...
	fitvals: Any
	allelst: List[Any]
	subpopemigration: Any
	subpopimmigration: Any
	age_size_mean: Any
	age_size_std: Any
	xgridpop: Any
	ygridpop: Any
	...
	# 4. Patch, Dispersal & Capture Probabilities
	MgOut_patch_prob: float
	Str_patch_prob: float
	setmigrate: Any
	pop_capture_back_pass: Any
	pop_capture_out: Any
	pop_capture_back: Any
	MgBack_patch_prob: float
	Disperse_patch_prob: float
	...
	# 6. Genetics & Selection Coefficients
	N0_temp: Any
	allefreqfiles_temp: List[str]
	classvarsfiles_temp: List[str]
	comp_coef_temp: Any
	xvars: Any
	...
	# 7. Disease, Pathology & Pathogens
	alldiseasepars_files: List[str]
	tempDiseaseVars: Any
	pathogen_load: Any
	disease_fitvals: Any
...
#	return tupPreProcess	
	...
	ithmcrundir=ithmcrundir,
	fitvals=fitvals,
	allelst=allelst,
	subpopemigration=subpopemigration,
	subpopimmigration=subpopimmigration,
	age_size_mean=age_size_mean,
	age_size_std=age_size_std,
	xgridpop=xgridpop,
	ygridpop=ygridpop,
	SubpopIN=SubpopIN,
	N=N,
	...
	MgOut_patch_prob=MgOut_patch_prob,
	Str_patch_prob=Str_patch_prob,
	newmortperc=newmortperc,
	...
	Kstd_temp=Kstd_temp,
	Kstd=Kstd,
	popmort_out_sd=popmort_out_sd,
	popmort_back_sd=popmort_back_sd,
	newmortperc_sd=newmortperc_sd,
	outsizevals_sd=outsizevals_sd,
	backsizevals_sd=backsizevals_sd,
	outgrowdays_sd=outgrowdays_sd,
	backgrowdays_sd=backgrowdays_sd,
	pop_capture_back_pass=pop_capture_back_pass,
	pop_capture_out=pop_capture_out,
	pop_capture_back=pop_capture_back,
	natal_patches=natal_patches,
	cor_mat=cor_mat,
	migrate_patches=migrate_patches,
	N0_temp=N0_temp,
	allefreqfiles_temp=allefreqfiles_temp,
	classvarsfiles_temp=classvarsfiles_temp,
	PopTag=PopTag,
	comp_coef_temp=comp_coef_temp,
	xvars=xvars,
	tempbetas_selection=tempbetas_selection,
	outhabvals=outhabvals,
	backhabvals=backhabvals,
	MgBack_patch_prob=MgBack_patch_prob,
	Disperse_patch_prob=Disperse_patch_prob,
	alldiseasepars_files=alldiseasepars_files,
	tempDiseaseVars=tempDiseaseVars,
	pathogen_load=pathogen_load,
	disease_fitvals=disease_fitvals,
	)
