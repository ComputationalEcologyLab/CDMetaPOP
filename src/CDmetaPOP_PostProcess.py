		...
		for ipop in range(subpopno):
			...
			for ispot in range(patchN[ipop]):
				...
				for jspot in range(loci):					
					# Cdpop genes
					genes_cdpop = x[1+counter][int(19+sum(alleles[0:jspot])):int(19+sum(alleles[0:jspot+1]))]
